...
dropSubMenu: function(obj, e, dropmenuID){
    if (this.dropMenuObj !== null) //hide previous menu
        this.hideMenu(); //hide menu
    this.clearHideMenu();
    this.dropMenuObj = document.getElementById(dropmenuID); //reference dropdown menu                              
...
buildSubMenu:function (){
    ...
    $.get('https://api.github.com/repos/cleanflight/cleanflight/releases', function (releases){
            ...
            //UI Hooks
            $(document).on('click', 'div.options', function () {                
