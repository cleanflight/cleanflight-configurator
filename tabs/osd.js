...
FONT.logo = function($el) {
    $el.append('<div class="font_text_row"><img src='+FONT.data.character_image_urls[1]+'></img>' +
            '<img src='+FONT.data.character_image_urls[2]+'></img>' +
            '<img src='+FONT.data.character_image_urls[3]+'></img></div>');
    $el.append('<br/>');
    $el.append('<div class="font_text_row"><img src='+FONT.data.character_image_urls[17]+'></img>' +
            '<img src='+FONT.data.character_image_urls[18]+'></img>' +
            '<img src='+FONT.data.character_image_urls[19]+'></img></div>');
}
        ...
        function updateOsdView() {
          // ask for the OSD config data
            ...
            */
            ...
            /*
            <div class="elementselect"><div class="checkbox"><div class="numberspacer" >
                        <input type="checkbox" checked id="box1" class="togglesmall" />
                    </div>
                    <label for="box1"><span>Element A</span></label>
                </div></div>
            */
